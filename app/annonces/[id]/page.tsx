    ...
    return (
        <main className="min-h-screen bg-gray-50">
            ...
            <nav className="bg-white shadow-sm px-6 py-4 flex justify-between items-center sticky top-0 z-50">
                ...
                <a
                    href="/publier"
                    className="bg-green-600 text-white px-4 py-2 rounded-full hover:bg-green-700 font-medium transition text-sm"
                >
                    + Publier
                </a>
            </nav>
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="rounded-2xl overflow-hidden shadow-lg mb-8 bg-gray-100">
                    {annonce.image_url ? (
                        ...
                        <div className="h-80 flex items-center justify-center text-8xl bg-gradient-to-br from-green-50 to-green-100">
                            🏠
                        </div>
                    )}
                </div>
                        ...
                        <div>
                            <div className="flex gap-2 flex-wrap mb-3">
                                ...
                                <span className="bg-orange-50 text-orange-600 px-3 py-1 rounded-full text-sm font-medium">
                                    📍 {annonce.quartier}, Ziguinchor
                                </span>
                                <span className="bg-gray-100 text-gray-500 px-3 py-1 rounded-full text-sm">
                                    Publié le {new Date(annonce.created_at).toLocaleDateString('fr-SN', {
                    ...
                    <div className="space-y-4">
                        <div className="bg-white rounded-2xl p-6 shadow-sm sticky top-24">
                            ...
                            <a
                                ...
                                className="flex items-center justify-center gap-2 w-full border-2 border-green-600 text-green-600 hover:bg-green-50 font-bold py-3 px-6 rounded-xl transition"
                            >
                                📞 {annonce.telephone}
                            </a>

                            <p className="text-xs text-gray-400 text-center mt-4">
                                Mentionnez Ziguinchor Immo lors de votre contact
                            </p>
                        </div>
